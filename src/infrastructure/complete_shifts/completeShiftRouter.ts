...
//admin
completeShiftRouter.get('/admin/complete_shifts', async (req: express.Request, res: express.Response) => {
...
//staff
completeShiftRouter.get('/staff/complete_shifts', async (req: express.Request, res: express.Response) => {
